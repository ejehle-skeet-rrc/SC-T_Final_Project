"""This is the main module for the assignment 7 project, in which
    all the class work, methods, etc are performed and called upon
    going through the full process of handling the bank transaction
    input_data file, processing it, then outputting into three
    seperate files that contain the processed data information
...
def main() -> None:
    ...
    data_processor = DataProcessor(transactions, 'fdp_team_4.log',
                                   logging.INFO)
